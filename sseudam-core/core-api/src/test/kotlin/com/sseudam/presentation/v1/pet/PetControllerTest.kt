    ...
    fun t1() {
        ...
        response.makeDocument(
            ...
            responseBody(
                ...
                "petId" type NUMBER means "펫 ID",
                "nickname" type STRING means "펫 닉네임",
                "point" type NUMBER means "펫 포인트",
                "levelType" type ENUM(Pet.LevelType::class) means "레벨 타입",
                "maxLevelStandard" type NUMBER means "레벨 최대 포인트 기준",
                "season" type STRING means "현 시즌",
                "createdAt" type STRING means "생성 일자",
            ),
        )
    }
    ...
    fun t3() {
        ...
        response.makeDocument(
            ...
            responseBody(
                ...
                "userPetInfo.userId" type NUMBER means "사용자 ID",
                "userPetInfo.petId" type NUMBER means "펫 ID",
                "userPetInfo.nickname" type STRING means "펫 닉네임",
                "userPetInfo.point" type NUMBER means "펫 포인트",
                "userPetInfo.levelType" type ENUM(Pet.LevelType::class) means "레벨 타입",
                "userPetInfo.maxLevelStandard" type NUMBER means "레벨 최대 포인트 기준",
                "userPetInfo.season" type STRING means "현 시즌",
                "userPetInfo.createdAt" type STRING means "생성 일자",
                "list" type com.sseudam.docs.support.ARRAY means "성장 기록 목록",
                "list[].userId" type NUMBER means "사용자 ID",
                "list[].nickname" type STRING means "펫 닉네임",
                "list[].point" type NUMBER means "펫 포인트",
                "list[].levelType" type ENUM(Pet.LevelType::class) means "레벨 타입",
                "list[].isLocked" type com.sseudam.docs.support.BOOLEAN means "잠금 여부",
                "list[].season" type STRING means "시즌",
                "list[].createdAt" type STRING means "생성 일자",
            ),
        )
    }
